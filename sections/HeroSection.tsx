    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I am a <b>Full-time content creator </b> with a passion 
            for delivering exceptional results for brands.
          </p>
          <p>
            With my expertise in video-editing and creating content and 
            helping viwers to looking better and helping their how to 
